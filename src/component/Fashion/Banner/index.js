            ...
            <div className="row">
                <div className="col-lg-6">
                    <div className="banner_text_one">
                        <h1 className="wow flipInX" data-wow-duration="3.0s" data-wow-delay=".3s">Factory<span className="wow flipInX" data-wow-duration="2.0s" data-wow-delay=".5s">AdikuGroup</span></h1>
