                ...
                <div className="offcanvas-mobile-menu-wrapper">
                    <div className="mobile-menu-bottom">
                        <div className="offcanvas-menu">
                            <ul>
                            <li>
                                    <a href="/" onClick={() => handleShow("home")}><span>Women</span></a>
                                </li>
                                <li>
                                    <a href="/about" onClick={() => handleShow("home")}><span>About</span></a>
                                </li>
                                <li >
                                    <a href="/baby-toys" onClick={() => handleShow("shop")}><span>Kids</span></a>
                                                                   </li>
                                <li>
                                    <a href="/electronics" onClick={() => handleShow("feature")}><span>Men</span></a>
                                                                    </li>
                                <li>
                                    <a href="/contact-two" onClick={() => handleShow("blogs")}><span>Contact</span></a>
                                                                  </li>
                            </ul>
                        </div>
                    ...
                    <div className="mobile-contact-info">
                        ...
                        <address className="address">
                            <span>Address:Kyrgyz Republic, Bishkek city, Alamudunsky district, Leninskoye village, 12/1 PMK - 3 str.</span>
                            <span>Call Us: +996 771 163 050</span>
                            <span>         +996 707 163 050</span>
                        </address>
            ...
            <div id="offcanvas-about" className="offcanvas offcanvas-rightside offcanvas-mobile-about-section">
                ...
                <div className="mobile-contact-info">
                    <address className="address">
                        ...
                        <span>Address:Kyrgyz Republic, Bishkek city, Alamudunsky district, Leninskoye village, 12/1 PMK - 3 str.</span>
                        <span>Call Us: +996 707 163 050</span>
                        <span>         +996 771 163 050 </span>
                    </address>
                    <ul className="social-link">
                    <li>
                                <a href="https://wa.me/996771163050"><i className="fa fa-whatsapp"></i></a>
